...
# 3. Load Gemini model with tool support
...
# -------- Step 2: Ask to buy (may interrupt) --------
state = graph.invoke({
    "messages": [
        {"role": "user", "content": "Buy 10 MSFT stocks at current price."}
    ]
}, config=config)

interrupt_msgs = state.get("__interrupt__")
if interrupt_msgs:
